...
% ============================================================
\section{The \texorpdfstring{$2\times2$}{2x2} DiD}
% ============================================================
...
% --- DiD over time -----------------------------------------
\begin{frame}{DiD is now the dominant quasi-experimental design}
  \centering
  \includegraphics[width=0.62\textwidth]{../Figures/L2_did_growth2.png} \\
...
\begin{frame}[shrink=20]{Controls in DiD are not like controls in OLS}
...
\begin{frame}{TWFE comparisons}
  \centering
  \includegraphics[width=0.72\textwidth]{../Figures/L2_bacon_goodman_full.png}
\end{frame}
